                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select data-rule-required="true" id="Drive" required>
                                        <option value="">Select </option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select data-rule-required="true" id="Transmission" required>
                                        <option value="">select</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Mileage</label>
                                    <input type="text" data-rule-required="true" id="mileage">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
        ...
        <script>
            function vent()
            {
                if($('#addVehicle').valid())
               {
                ...
                formdata.append("brand", document.getElementById("brand").value);formdata.append("Drive", document.getElementById("Drive").value);
                formdata.append("Transmission", document.getElementById("Transmission").value);formdata.append("mileage", document.getElementById("mileage").value);
                ...
                fetch(`AddListing`, {method:"POST", body:formdata}).then(data=>data.text()).then(resp=>{
